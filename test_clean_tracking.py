#!/usr/bin/env python3
"""
Clean tracking test - starts fresh without history.
"""
...
def test_clean_tracking():
    """Test tracking with clean history."""
    ...
    # Setup logging
    setup_logger("INFO", "logs/clean_tracking.log")
    ...
    print(f"Clean tracking test on {total_frames} frames at {fps} FPS")
    print("=" * 50)
